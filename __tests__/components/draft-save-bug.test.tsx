...
describe('API: PATCH /api/dispatches/[id] の isDraft 処理', () => {
  it('body に isDraft が含まれていれば allowed に追加される', () => {
    ...
    const body = { isDraft: true, vehicleNumber: 'V001', malicious: 'DROP TABLE' }
    ...
    expect(allowed).toEqual({ isDraft: true, vehicleNumber: 'V001' })
  ...
  it('body に isDraft が含まれていなければ Dispatch.isDraft は変更されない', () => {
    ...
    const body = { dispatchTime: '2026-04-14T10:00:00Z', vehicleNumber: 'V001' }
    ...
    expect(allowed).toEqual({ vehicleNumber: 'V001' })
  })
})
